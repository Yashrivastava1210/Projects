...
print("Total time for read operation in sequential consistency: "+ str(end - start))
clientSocket.close()
...
print("Operation starting at: "+ str(now))
start = time.time()
command1 = "set test1 50 sequential\r\n"
...
print("**************************************************************************\n")
clientSocket.close()
print("Total time for write operation in sequential consistency: "+ str(end - start))
